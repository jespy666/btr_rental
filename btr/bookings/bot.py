...
#             context.user_data['bikes'] = bikes_num
#             message = _(
#                 'Ok!\n'
...
#         slots_view = await get_free_slots_for_bot_view(date)
...
#                 'Your start time:\n\n{time}\n\n'
#                 'Enter the number of hours (example: 2):'
#             ).format(date=date, slots=slots_view, time=start)
...
#                 'Please select a start time based on available slots:\n\n'
#                 '{slots}\n\n'
#             ).format(start=start, slots=slots_view)
#             await context.bot.send_message(
#                 chat_id=update.effective_chat.id,
#                 text=message
#             )
...
#         hours = update.message.text
#         interval = calculate_time_interval(start, hours)
#         end = interval.get('end_time')
#         message = ''
#         try:
#             validate_time(end)
